...
import 'supervisorReportAccidents.dart';
...
class _SupervisorDashboardState extends State<SupervisorDashboard> {
  ...
  List<Widget> _buildDrawerItems(BuildContext context) {
    return [
      ...
      _buildDrawerTile(context, 'Report Accidents', Icons.warning, supervisorReportAccidents()),
  ...
  List<Widget> _buildDashboardButtons(BuildContext context) {
    return [
      ...
      _buildDashboardButton(context, 'Accidents & Incidents', Icons.warning, Colors.red[700]!, supervisorReportAccidents()),
